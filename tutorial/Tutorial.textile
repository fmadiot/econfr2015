...
To test this rule, use the _Property View_ to introduce an error in the model: set the father of a Man to its son.
...
Then, set the _Qualified Class Name_ property to @org.eclipse.sirius.sample.basicfamily.design.services.FamilyServices@.
